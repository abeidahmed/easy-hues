      ...
      <section className="service">
        <div className="container">
          <div className="service-wrapper">
            <h2 className="service-title">A better way to send money</h2>
            ...
            <div className="service-inner">
              <div className="service-inner-left">
                <h3 className="service-inner-title">Single-click transfers</h3>
                <p className="service-inner-desc">
                  Non sollicitudin lobortis quis quis vel, sem nisl turpis. Arcu libero volutpat
                  amet, elementum. Enim interdum potenti platea purus imperdiet hac. Tristique at
                  egestas porttitor in leo. Pharetra id ornare netus venenatis arcu auctor.
                </p>
                <div className="service-offer-container">
                  <div className="service-offer-wrapper">
                    <div className="service-offer-left">
                      ...
                      >
                        <path d="M15 0H45L30 60H0L15 0Z" fill="#EBF4FF" />
                        <path
                    ...
                    <div className="service-offer-right">
                      <h4 className="service-offer-title">Accept any type of card</h4>
                      <p className="service-offer-desc">
                  ...
                  <div className="service-offer-wrapper">
                    ...
                    <div className="service-offer-right">
                      <h4 className="service-offer-title">Instance status updates</h4>
                      <p className="service-offer-desc">
