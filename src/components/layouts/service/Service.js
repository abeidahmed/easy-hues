          ...
          <div className="service-inner">
            <div className="service-inner-left">
              <h3
                ...
                className="service-inner-title"
              >
                Single-click transfers
              </h3>
              <p style={{ color: props.colorChange["Text color"] }} className="service-inner-desc">
              ...
              <div className="service-offer-container">
                <div className="service-offer-wrapper">
                  <div className="service-offer-left">
                    ...
                    >
                      <path
                        d="M15 0H45L30 60H0L15 0Z"
                        fill={props.colorChange["Icon background color"]}
                      />
                      <path
