...
const Service = props => {
  const { background, heading, text, icon, iconBackground } = props.colorChange;

  return (
    <section style={{ backgroundColor: background }} className="service">
      <div className="container">
        <div className="service-wrapper">
          <div className="service-intro">
            <h2 style={{ color: heading }} className="service-title">
              A better way to send money
            </h2>
            <p style={{ color: text }} className="service-desc">
          ...
          <div className="service-inner">
            <div className="service-inner-left">
              <h3 style={{ color: heading }} className="service-inner-title">
                Single-click transfers
              </h3>
              <p style={{ color: text }} className="service-inner-desc">
              ...
              <div className="service-offer-container">
                <div className="service-offer-wrapper">
                  <div className="service-offer-left">
                    ...
                    >
                      <path d="M15 0H45L30 60H0L15 0Z" fill={iconBackground} />
                      <path
