      ...
      <section className="property">
        <div className="container">
          <div className="property-wrapper">
            <h3 className="property-intro">A better way to send money</h3>
            <p className="property-intro-info">
            ...
            <div className="property-flexed-container">
              <div className="property-container">
                <h4 className="property-title">Accepted Payments</h4>
                <div className="property-info">
                  <div className="property-desc">
                    ...
                    <span className="property-name">Neque, aliquet</span>
                  </div>
                  <div className="property-desc">
                    <svg
                      width="20"
              ...
              <div className="property-container">
                <h4 className="property-title">Send Invoices</h4>
                <div className="property-info">
                  <div className="property-desc">
                    <svg
                      width="20"
              ...
              <div className="property-container">
                <h4 className="property-title">Receive Payments</h4>
                <div className="property-info">
                  <div className="property-desc">
                    <svg
                      width="20"
              ...
              <div className="property-container">
                <h4 className="property-title">Advanced Analytics</h4>
                <div className="property-info">
                  <div className="property-desc">
                    <svg
                      width="20"
