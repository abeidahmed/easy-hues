...
const Testimonial = props => {
  const { background, text, textAccent, icon, border } = props.colorChange;

  return (
    <section style={{ backgroundColor: background }} className="test">
      <div className="container">
        <div className="test-container-global">
          <div className="test-wrapper">
            <div style={{ borderColor: border }} className="test-main">
              <div className="test-svg-container">
                ...
                >
                  ...
                  <path
                    ...
                    fill={icon}
                  />
                  <path d="M0 6.00001L18 0V31.5L0 25.5V6.00001Z" fill={icon} />
                </svg>
              </div>
              <div className="test-container">
                <p style={{ color: text }} className="test-desc">
                ...
                <div className="test-inner">
                  ...
                  <div className="test-details">
                    <span style={{ color: text }} className="test-name">
                      Judith Black
                    </span>
                    <span style={{ color: textAccent }} className="test-position">
                      CEO, Tuple
                    </span>
                  </div>
                </div>
