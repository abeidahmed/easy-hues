            ...
            <div className="test-main">
              <div className="test-svg-container">
                ...
                >
                  ...
                  <path
                    ...
                    fill="#C3DAFE"
                  />
                  <path d="M0 6.00001L18 0V31.5L0 25.5V6.00001Z" fill="#C3DAFE" />
                </svg>
              </div>
              <div className="test-container">
                ...
                <div className="test-inner">
                  <span className="test-name">Judith Black</span>
                  <span className="test-position">CEO, Tuple</span>
                </div>
              </div>
            </div>
            <div className="test-main">
              ...
              <div className="test-container">
                ...
                <div className="test-inner">
                  <span className="test-name">Tiffany Bright</span>
                  <span className="test-position">Project Manager, Workcation</span>
                </div>
              </div>
            </div>
          </div>
