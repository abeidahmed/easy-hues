...
const Testimonial = props => {
  ...
  const imgBorderColor = {
    borderColor: props.colorChange["Text accent color"]
  };
  const positionColor = {
    color: props.colorChange["Text accent color"]
  };
  const iconColor = () => {
    return props.colorChange["Icon color"];
  };
  return (
    <section style={backgroundColor} className="test">
              ...
              <div className="test-svg-container">
                ...
                >
                  ...
                  <path
                    ...
                    fill={iconColor()}
                  />
                  <path d="M0 6.00001L18 0V31.5L0 25.5V6.00001Z" fill={iconColor()} />
                </svg>
              </div>
              <div className="test-container">
                <p style={textColor} className="test-desc">
                ...
                <div className="test-inner">
                  ...
                  <div className="test-details">
                    <span style={textColor} className="test-name">
                      Judith Black
                    </span>
                    <span style={positionColor} className="test-position">
                      CEO, Tuple
                    </span>
                  </div>
                </div>
