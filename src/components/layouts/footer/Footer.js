...
const Footer = props => {
  ...
  const logoColor = () => {
    return props.colorChange["Logo color"];
  };
  return (
        ...
        <div className="footer-wrapper-container">
          <div className="footer-wrapper">
            <nav className="footer-contents">
              <h4 style={headingColor} className="nav-title">
                Company
              </h4>
              <ul className="nav-container">
                <a style={textColor} className="footer-links" href="#!">
                  Changelog
                </a>
                <a style={textColor} className="footer-links" href="#!">
                  About
          ...
          <div className="footer-brand">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
              <g transform="translate(.648 2.438) scale(.05696)" fill="none" fillRule="evenodd">
                <circle r="50.167" cy="237.628" cx="269.529" fill={logoColor()} />
                <g stroke={logoColor()} strokeWidth="24">
            ...
            <span style={textColor}>Built with React</span>
          </div>
        </div>
        <div className="footer-copyright">
          <p style={textColor} className="copyright-text">
